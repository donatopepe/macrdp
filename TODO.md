...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  drain-state (tested), explicit ingress-batch budget, observable urgent budget, writer-error, partial-write, all-class typed ingress, ingress counters/snapshot accessors,

...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  owner now exposes writer construction, typed ingress-writer handoff, `with_ingress` setup, and explicit shutdown/drain signaling tests for a future controlled handoff, but live wiring remains blocked.

...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  owner now exposes writer construction, a typed ingress-writer handoff test, and `with_ingress` setup for a future controlled handoff, but live wiring remains blocked.

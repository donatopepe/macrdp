...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  drain-state (tested), explicit ingress-batch budget, observable/exhausted urgent budget, writer-error, partial-write, all-class typed ingress, ingress counters/snapshot accessors,

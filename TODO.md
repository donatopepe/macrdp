...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  drain, writer-error, partial-write, and fake-writer tests; it awaits each write exactly once and
  never retries a failed/partially written buffer. Scheduler remains
...
- [ ] **A/V desync under packet loss** (user-reported 2026-06-29, after P3). Audio drifts
  ...
  counters plus maximum projected backlog, and debug logs include queue duration before/after trim.
  Detail:

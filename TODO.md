...
- [~] **Live socket-owner adapter** — blocked safely at design boundary: current
  ...
  drain, writer-error, partial-write, all-class typed ingress, and fake-writer tests; it awaits each write
  exactly once and never retries a failed/partially written buffer. Scheduler remains
